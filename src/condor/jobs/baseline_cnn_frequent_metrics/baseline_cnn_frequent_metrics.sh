...
echo "###### RUNNING CODE: #########"
# echo "###### baseline_cnn_lab4.py ######" >> experiments/outputs/experiments.txt
# python3 baseline_cnn_lab4_frequent_metrics.py >> experiments/outputs/experiments.txt
echo "###### baseline_cnn_lab4.py ######" 
python3 baseline_cnn_lab4_frequent_metrics.py 
echo "####### DONE #########"
