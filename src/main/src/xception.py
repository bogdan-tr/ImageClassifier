"""
xception model to act as a SOTA (state-of-the-art) baseline. E.g an upper end baseline to see how well my model
does against the state-of-the-art "good models" Not for submission
"""
...
def main():
    ...
    num_epochs = random.randint(4, 7)  # NOTE: hardcode to 2 as takes too long to train
    hyperparams.random_epochs = num_epochs
