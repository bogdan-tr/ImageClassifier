"""
mesonet implementation based on diagram from paper, but with a 3-layer MLP
"""
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 32, 3, padding=1),  # same conv
            nn.BatchNorm2d(32),
            nn.ReLU(),
...
def main():
    ...
    # make datafram and save as csv for progress tracking
    df = pd.DataFrame(
        train_progress,
